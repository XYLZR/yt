...
<body scroll="no">
	<div id="layout">
		<div id="header">
			<div class="headerNav">
				<div style="font-size: 25px;font-weight: bold;color: #fff;padding-left:10px;height: 40px;;padding-top: 10px;">学生请假审批系统</div>
				<ul class="nav">
				...
				<c:if test="${role=='role0'}">
					...
					<div class="accordionContent">
						...
						<li><a>应用</a>
								...
								<ul>
									<li><a href="banji/banjilist.html" target="navTab" rel="banjiList" >班级管理</a></li>
								</ul>
								<ul>
				...
				<div class="navTab-panel tabsPageContent layoutBox">
					<div class="page unitBox">
						<div class="accountInfo">
							<p><h1 style="font-size: 22px;text-align: center;">您好，${username}。欢迎使用学生请假审批系统！</h1></p>
						</div>
